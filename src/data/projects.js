...
Также участвую в доработке клиентских проектов, которые приходят от производства — помогая доводить их до финала или адаптируя под выпуск.`,
      en: `A project with a full-cycle production company operating in the B2B segment. The collaboration involves responsibility for the visual aspect — both internal materials and tasks coming from their clients.
...
The work also includes finalizing client projects that come from production — helping to bring them to completion or adapting them for release.`
    },
    client: "Textile.Guru",
    year: {
      ru: "2022 → Наст.время",
...
Основная цель — поддерживать и развивать визуальный язык бренда, обеспечивая его актуальность, узнаваемость и стилистическую целостность. Рабочие процессы включают быстрые итерации, адаптацию графики под новые запуски и участие в разработке визуального контента на всех этапах.`,
      en: `Collaboration with the Fable brand is built on regular work in tandem with their in-house art director. The involvement spans all visual tasks — from digital materials to print products, from brand graphics to collection design.
...
The project involved creative solutions where the print became the key carrier of the idea, working with street culture references and current visual codes. Concepts included graphics, text elements, and work with rhythm on the clothing surface.`
    },
    client: "0NOT1",
    year: "2023 → 2024",
    role: {
...
Основная задача — выстраивать стабильную визуальную среду бренда, реагируя на текущие потребности, но сохраняя характер и эстетику марки. Часто работаю напрямую с командой бренда, обеспечивая оперативную и системную визуальную поддержку.`,
      en: `The collaboration with SAMB is on an ongoing basis as their primary designer. The work involves supporting the brand's visual communication at all stages: from graphic materials for collections to presentation and corporate assets.

The main task is to build a consistent visual environment for the brand, responding to current needs while maintaining the character and aesthetics of the brand. The process often involves direct work with the brand team, providing prompt and systematic visual support.`
    },
    client: "SAMB",
    year: {
      ru: "2023 → Наст.время",
  ...
  },
  {
    ...
    description: {
      ...
      en: "Structure, language, and interaction — an independent project embodying a personal approach to design."
    },
    longDescription: {
...
Визуальный язык построен на контрастах, читаемости и чётком иерархическом ритме. Особое внимание — навигации, пользовательским сценариям и адаптации под разные устройства. Это не просто "визитка", а инструмент для коммуникации с профессиональной аудиторией.`,
      en: `Creating this portfolio became a full-fledged design case — from concept and structure to implementation. The main task was to convey professional vision and experience in the most honest and comfortable form for perception.
...
Интересны как краткосрочные креативные задачи, так и долгосрочные проекты, где можно влиять на визуальную стратегию и рост бренда. Умею встраиваться в команды, вести проекты в одиночку и адаптироваться под разные рабочие процессы.`,
      en: `Available for new tasks — both as an executor and in positions requiring strategic vision. The experience covers branding, visual communication, packaging, web design, and digital environment.

Both short-term creative tasks and long-term projects where one can influence visual strategy and brand growth are of interest. The skill set includes integrating into teams, leading projects independently, and adapting to different work processes.`
    },
    client: {
      ru: "Вы",
      en: "You"
